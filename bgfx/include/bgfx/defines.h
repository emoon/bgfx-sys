...
#define BGFX_CAPS_TEXTURE_COMPARE_RESERVED (0x0000000000080000)
#define BGFX_CAPS_TEXTURE_COMPARE_LEQUAL (0x0000000000100000) //!< Texture compare less equal mode is supported.
#define BGFX_CAPS_TEXTURE_CUBE_ARRAY (0x0000000000200000)	  //!< Cubemap texture array is supported.
#define BGFX_CAPS_TEXTURE_DIRECT_ACCESS (0x0000000000400000)  //!< CPU direct access to GPU texture memory.
#define BGFX_CAPS_TEXTURE_READ_BACK (0x0000000000800000)	  //!< Read-back texture is supported.
#define BGFX_CAPS_VERTEX_ATTRIB_HALF (0x0000000001000000)	  //!< Vertex attribute half-float is supported.
#define BGFX_CAPS_VERTEX_ATTRIB_UINT10 (0x0000000002000000)	  //!< Vertex attribute 10_10_10_2 is supported.
#define BGFX_CAPS_VERTEX_ID (0x0000000004000000)			  //!< Rendering with VertexID only is supported.
#define BGFX_CAPS_VIEWPORT_LAYER_ARRAY (0x0000000008000000)	  //!< Viewport layer is available in vertex shader.
...
#define BGFX_STATE_BLEND_FUNC_SEPARATE(_srcRGB, _dstRGB, _srcA, _dstA) ((0) | (((uint64_t)(_srcRGB) | ((uint64_t)(_dstRGB) << 4))) | (((uint64_t)(_srcA) | ((uint64_t)(_dstA) << 4)) << 8))
